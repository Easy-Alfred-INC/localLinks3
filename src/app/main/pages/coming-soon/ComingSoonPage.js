...
import { 
	...
	// handleTotalCostChip, 
	handleCostColumn, 
	handleGuestAndHourCount } from 'app/services/helper.js';
...
function ComingSoonPage() {
	...
	const eventRows = Object.keys(events).filter((i)=> !events[i].isLocked ).map((key, value) => {
						...
						<TableBody>
							{eventRows.map(row => {
								...
								<TableCell>
									...
									{' '}
									{/* {;} */}
									{row.serviceTitle} {row.subServiceTitle &&`(${row.subServiceTitle})`}
								</TableCell>
								<TableCell >
									{row.date}
								</TableCell>
								<TableCell >
									{handleGuestAndHourCount(row)}
								</TableCell>
								<TableCell>
									${handleCostColumn(row)}
								</TableCell>
							</TableRow>
							)})}
							<TableRow>
					...
					<div className="flex flex-col items-center justify-center w-full">
						<Card className="w-full ">
							<CardContent className="flex flex-col items-left justify-left p-32">
								...
								<Typography variant="subtitle1" className="text-left w-full" color="textSecondary">
									1) Click
									<Button
										href='#'
										rel="noreferrer noopener"
									...
									to set your plan. For immediate questions, call now. We're excited to get to know you.
								</Typography>
								<br/>
								<Typography  variant="subtitle1" className="text-left w-full" color="textSecondary">
									2) Our team identifies the best local businesses to complete your needs. This can take up 2-3 business hours to coordinate.
								</Typography>
								<br/>
								<Typography  variant="subtitle1"  className="text-left w-full" color="textSecondary">
									3) Your Connector will call you at the scheduled time. Please ensure you are available to speak.
								</Typography>
								<br/>
								<Typography  variant="subtitle1"  className="text-left w-full" color="textSecondary">
									4) Whether you're booking for tomorrow or 6 months from tomorrow, we work to ensure your services and power partner are perfect for you!
								</Typography>
